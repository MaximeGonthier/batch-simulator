...
\footnote{The logs
  available with the reproducible code}. 
  \todo[inline]{LM: change this footnote if we manage to make anonymous logs available. Max: Okay done.}
...
This works open several exciting future directions.
