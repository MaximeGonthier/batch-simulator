...
$\memory(\Node{i})$\todo{Sam: rather M?},
...
\todo[inline]{Max: Do we need to talk about the objective in the
  framework?\\
  LM: Yes, I totally forgot. Will add this later.}
...
\begin{algorithmic}[1]
	\ForEach{$J_i \in$ the jobs queue}
		...
		\EndFor
                ...
                \State Schedule $J_i$ on $\core(J_i)$ cores of \Node{k} that are available starting from $t_k$
                \State Mark these cores busy until time $t'_k +\walltime(J_i)$
...
performance of the system by delaying subsequent jobs.  We present here three
...
\end{algorithmic}
\todo[inline]{Sam: shouldn't it take into account the file loading time,
thus t'k?}
...
index is the default behaviour in most systems.}
...
Our main competitors on this metric are FCFS and EFT, with and without backfilling.
...
\begin{figure}[tb]\centering\includegraphics[scale=0.41]{../MBSS/plot/Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Number of evaluated jobs re-using a data on July 16. Carl: I prefer July 16. A comment is also that file names containing > might cause prodcuction problems if the conference accepts tex files for submission.}\label{reuse.07-16}\end{figure}
...
\begin{figure}[tb]\centering\includegraphics[scale=0.41]{../MBSS/plot/Cluster_usage/2022-07-16->2022-07-16_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Visualization of the utilization rate of the cluster on the workload of July the 16th with FCFS.}\label{07_16_cluster_usage_fcfs}\end{figure}
\begin{figure}[tb]\centering\includegraphics[scale=0.41]{../MBSS/plot/Cluster_usage/2022-07-16->2022-07-16_V10000_Fcfs_with_a_score_x500_x1_x0_x0_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Visualization of the utilization rate of the cluster on the workload of July the 16th with LEA.}\label{07_16_cluster_usage_lea}\end{figure}
...
Thus, on underused clusters, LEO will have a behaviour\todo[inline]{Max:
Or behavior? It's british or american english right? Sam: yes, -our is
english, -or is american. Same for colour/color etc.} close to EFT, while trying to minimize evictions.
...
On the contrary, LEA favours\todo[inline]{Max: Or favor? Sam: idem :)} data re-use over an early start time for a job.
...
that LEM does not fall in LEA's pathological case.
...
\begin{figure}[tb]\centering\includegraphics[scale=0.41]{../MBSS/plot/Cluster_usage/2022-03-26->2022-03-26_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Visualization of the utilization rate of the cluster on the workload of March the 26th with FCFS.}
\label{cluster_usage.03-26_fcfs}\end{figure}
\begin{figure}[tb]\centering\includegraphics[scale=0.41]{../MBSS/plot/Stretch_times/Stretch_times_FCFS_LEM_2022-03-26->2022-03-26_V10000_450_128_32_256_4_1024.pdf}\caption{Stretch times of each job of LEM compared to FCFS on the workload of March the 26th.}
...
\begin{figure}[tb]\centering\includegraphics[scale=0.41]{../MBSS/plot/Cluster_usage/2022-08-16->2022-08-16_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Visualization of the utilization rate of the cluster on the workload of August 16 with FCFS.}
...
Firstly, it's a workload that heavily saturates the cluster as can be seen on Figure~\ref{cluster_usage.08-16_fcfs}
...
A large decrese in the time spent waiting for a file greatly reduces the stretch of each job.
...
strategy is much more consistent, while still having great speed-ups in some cases, as can be seen with the outliers above the 1.5 mark.
