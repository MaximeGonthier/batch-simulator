...
on X\todo{Max: Update} days extracted from a real workload history.

\subsection{Settings\todo[inline]{Max: Maybe this section should be merged with the one above?}}
...
\todo[inline]{Max: Should I add -BF in the acronyms of BF? Here I instead put dashed lines in the barplot.}
...
\begin{figure}[tb]\centering\includegraphics[scale=0.47]{../MBSS/plot/Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Average stretch of all jobs evaluated on July 16.}\end{figure}
\begin{figure}[tb]\centering\includegraphics[scale=0.47]{../MBSS/plot/Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Number of evaluated jobs re-using a data on July 16.}\end{figure}
\begin{figure}[tb]\centering\includegraphics[scale=0.47]{../MBSS/plot/Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Amount of time spent waiting for a file to be available on July 16.}\end{figure}

\todo[inline]{Max: -Quick talk on results}
...
\todo[inline]{Max: -Explain how to read figure of cluster's usage.}
...
\todo[inline]{Max: -Explain that on underused cluster SCORE uses less nodes and everyone else just does FCFS, EFT has small benefit but almost not noticeable.}
...
\todo[inline]{Max: -Explain appeal of EFT-SCORE MIX: not falling in score's weakness. The cluster usage is almost the same as the one of FCFS}
...
\todo[inline]{Max: -Explain that with the threshold it's not perfect in this case and we fall in the same issues as SCORE. We even see on the cluster's usage plot the queue of evaluated jobs not being scheduled.}
...
\todo[inline]{Max: -Talk on results when saturated, maybe show a gantt chart}
...
\todo[inline]{Max: Say that we logically gain more on FCFS than FCFS BF, thus the results are like that. 01-28 is a good example to talk about it and show on the same plot with and without backfilling.}
...
\todo[inline]{Max: Is it ok if we only talk about the outliers of SCORE without showing them on the figure?}
...
\begin{figure}\centering\includegraphics[scale=0.47]{../MBSS/plot/ECDF/ecdf_mean_stretch_all_workloads.pdf}\caption{ECDF}\end{figure}
\begin{figure}\centering\includegraphics[scale=0.47]{../MBSS/plot/ECDF/ecdf_mean_stretch_all_workloads_bf.pdf}\caption{ECDF with backfilling}\end{figure}

\todo[inline]{Max: -Talk about jump in ECDF, large whiskers and outliers, mean and median}
