...
\begin{figure}[H]\centering\includegraphics[scale=0.47]{../MBSS/plot/Cluster_usage/2022-07-16->2022-07-16_V10000_Fcfs_with_a_score_x500_x1_x0_x0_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Visualization of the utilization rate of the cluster on the workload of July the 16th with LEA.}\end{figure}
...
\todo[inline]{Max: -Explain that on underused cluster LEA uses less nodes and everyone else just does FCFS, EFT has small benefit but almost not noticeable.}
...
\todo[inline]{Max: -Explain appeal of LEM: not falling in score's weakness. The cluster usage is almost the same as the one of FCFS}
...
\todo[inline]{Max: -Explain that with the threshold it's not perfect in this case and we fall in the same issues as LEA. We even see on the cluster's usage plot the queue of evaluated jobs not being scheduled.}
