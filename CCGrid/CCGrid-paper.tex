...
%~ Abstract by Loris:
  ...
  SLURM \todo[inline]{Max: Should we explicit the "Simple Linux Utility for Resource Management"?LM: I think it's fine in the abstract, we give a reference below} or OAR to allocate computing jobs onto nodes. These schedulers
  ...
  sharing large input files: in data-intensive scenarios \todo[inline]{Max: Should we precise that it's in certain areas of research that you are really highly data-dependent? LM: maybe again give details about this in the introduction}, tens to
  ...
  thus in a larger delay as well. We study how to design a \textit{data-aware
