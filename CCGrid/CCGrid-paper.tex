...
\textit{Day 1}.
With this process we also gather jobs that were started before \textit{Day 0}.
Jobs from \textit{Day -1} are jobs that were submitted before \textit{Day 0} and that are still running at the beginning of \textit{Day 0}.
