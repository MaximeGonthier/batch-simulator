...
on X\todo{Max: Update} days extracted from logs of historical submitted jobs.

\subsection{Settings}
\todo[inline]{Max: Maybe the settings subsection should be merged with the one above?}
...
Each application scenario is a day on the log's history of
the workload.
...
\todo[inline]{Max: Should I add -BF in the acronyms of BF? Here I instead put dashed lines in the barplot like on figure 20. Maybe I can do that each time I show the barplots?}
