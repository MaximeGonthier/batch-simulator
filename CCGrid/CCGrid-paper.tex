...
Having $\mathbb{M} = {M_1, M_2, ..., M_l}$ different nodes sizes raises a new constraint. The model would have
...
The flow of a job is the total amount of time the job spent in the systems, i.e
the duration between the submission time and it's completion. The flow
...
\todo[inline]{Max: - Results of LEA, LEO and LEM - Fairness - Advance reservation - Tune LEM - Improve locality of LEO - Tune BF for LEA, LEO and LEM}
