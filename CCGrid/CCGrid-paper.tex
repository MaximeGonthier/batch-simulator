...
HDFS is mainly a storage system, thus it uses an historic on files locations to serve as a backup. \todo[inline]{Elisabeth: I don't understand the previous sentence. Could it be a history of file locations? How does it serve as a backup? Is it becasue the files have been duplicated and exist in several places?}
...
\todo[inline]{Elisabeth: control data loads and limit evictions?}
