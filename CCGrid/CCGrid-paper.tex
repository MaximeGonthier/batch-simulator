...
%It is particularly used to store large volume of data on a large number of systems.
...
Our focus will be to control data loads in order to limits eviction.
Our processing order will naturally limits thrashing.

Agrawal et al.~\cite{Scheduling_Shared_Scans_of_Large_Data_Files}
propose to schedule first jobs not sharing a file
