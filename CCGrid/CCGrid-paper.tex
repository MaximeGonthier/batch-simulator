...
To optimize the utilisation rate of a cluster, many strategies have been proposed like Gang scheduling~\cite{gang_scheduling} or Maui~\cite{Maui_Scheduler}.
However these schedulers do not consider the issue
of dealing with data-intensive workloads.

\subsection{Using Distributed File System to deal with data-intensive workloads}
