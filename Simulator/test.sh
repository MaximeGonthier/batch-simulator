...
# bash test.sh set_of_endpoints_1 8_functions_4_endpoints_64coresmax_8users_balanced_randomize_weight 8 64
...
#~ for i in range 0, 30
	./src/main inputs/workloads/converted/${workload} inputs/clusters/${endpoints} no_schedule 0 outputs/${workload}_${i}.csv 0 100 ${nusers}
	

#~ TODO: take mean on 30 exec
