...
# python3 write_workload.py output_file
...
for i in range 0, N_functions*N_users*N_cores_max:
		f.write("{ id:", i, "subtime:", 0, "delay:", 0, "walltime:", 0, "cores", i_cores, "user:", users[i_user], "data:", 0, "data_size:", 0, "workload:", 0, "start_time_from_history:", 0, "start_node_from_history:", 0, "duration_on_machine:")
