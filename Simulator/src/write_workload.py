...
# python3 src/write_workload.py outputs/8_functions_4_endpoints_64coresmax
import sys

output_file = sys.argv[1]

# Inputs (todo: put in a file or in the command line)
# ~ nusers user1 user2 ... usern nmachines machine1 machine2 ... machinen nfunctions function1 function2 ... functionns
N_users = 4
...
for i in range (0, N_functions*N_users*N_cores_max):
	f.write("{ id:" + str(i), "subtime:" + str(0), "delay:" + 0, "walltime:", 0, "cores", i_cores, "user:", users[i_user], "data:", 0, "data_size:", 0, "workload:", 0, "start_time_from_history:", 0, "start_node_from_history:", 0, "duration_on_machine:")
	for j in range (0, N_endpoints):
		f.write(functions_runtime[i_functions*i_endpoint+j])
	f.write("energy_on_machine:")
	for j in range (0, N_endpoints):
		f.write(functions_energy[i_functions*i_endpoint+j])
