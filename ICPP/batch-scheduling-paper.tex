...
\todo[inline]{Max: Do we want, from the introduction, talk more about the application cases that needs large input data?}
...
\end{itemize}
\todo[inline]{Max: Re-write the contribution section}
...
\begin{tabular}{ |c|c|c|c|c| }
  ...
  \hline
  Reduction from FCFS & +0.03\% & -14.8\% & -0.75\% & -3.78\% \\
  \hline
\end{tabular}
...
\subsection{Aggregated results on 12 different evaluated weeks of the workload\todo[inline]{Max: Maybe another title would be better?}}
...
\todo[inline]{Max: Talk about core hours reduction and total transfer reduction with for core hours:
%~ # Core hours MAX is 19595520
