...
It is the stretch of each \us that will be shown in this Section.
...
on a simulator that we developed\footnote{You can find the code and the anonymized logs of the workloads at: \url{https://github.com/userdoubleblind/Locality-aware-batch-scheduling}}.
