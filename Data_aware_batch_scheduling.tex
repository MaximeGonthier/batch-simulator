...
\begin{itemize}
	...
	\item $T_{max} \gets max(\frac{Area(J_l)}{K_l}, \frac{Area(J_l) + Area(J_{l - 1})}{K_l + K_{l - 1}}, ..., \frac{Area(\jobset)}{K})$, with $K_x$ the total number of nodes of size $x$.
...
\begin{itemize}
	...
	\item $Remaining\_Area[x] \gets Tmax \times K_x$
