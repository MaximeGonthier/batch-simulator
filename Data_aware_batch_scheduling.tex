...
\begin{itemize}
	...
	\item I tested with a larger working set (3 days) and the resukts are worse for fcfs with area filling (see below Figure~\ref{29}) because the number of upgraded jobs si lower.
\end{itemize}
...
\begin{itemize}
	\item With a normal cluster: \begin{itemize}
		\item I have not been able to upgrade jobs apart from backfilling. even with bigger multiplier on planned area for fcfs with a score
