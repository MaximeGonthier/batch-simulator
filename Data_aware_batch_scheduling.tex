...
\caption{Size and constraint - Workload January 21 (45000 jobs) with 95\% of 128 jobs, 3\% of 256 jobs, 2\% of 1024 jobs - Normal cluster - September 23}\label{49}\end{figure}

Idée: quand la taille de la liste de jobs a schedule est plus grande que le nombre de noeud disponibles (par catégorie si on prend la contrante de taille), alors on fais
avec les multiplicateur. Les multiplicateurs dépendnet de la taille de la donnée. Pour 128 et moins: x1 x1 x0 x0, pour entre 128 et 256 on fais ? et voir les stats pour chaque type de taille.
