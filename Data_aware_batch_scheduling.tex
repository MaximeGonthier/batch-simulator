...
\begin{enumerate}
	...
	\end{enumerate}
	\item For each package $k$ do
	\begin{enumerate}
		\item $Nb\_nodes\_allocated\_package\_k \gets \frac{Nb\_cores\_requested\_package\_k \times Nb\_cores\_cluster}{\sum_{i=0}^{n} Nb\_cores\_requested\_package\_i}$ rounded to the lowest node (so if I need 25 cores I will be granted 20 cores from 1 node, if I need 59, i will be granted 40 from 2 nodes).
