...
\todo[inline]{The following pseudocode is then executed at each time $t$ ?}
\begin{algorithm}[H]
...
\begin{figure}[ht] 
  ...
  \begin{minipage}[b]{0.5\linewidth}
    ...
    \vspace{4ex}
  \end{minipage} 
  \caption{Workload 2021-05-23 - April 27}
\end{figure}
% Flow
\begin{figure}[ht] 
  \label{ fig7} 
...
\end{figure}
% Transfer time
\begin{figure}[ht]\includegraphics[scale=1]{MBSS/plot/2021-05-23_Total_transfer_time.pdf}\caption{Transfer time - Workload 2021-05-23 - April 27}\end{figure}
