...
\begin{enumerate}
	\item Compute score on all nodes. If the size of a node is bigger than your size $x$, add a malus equal to: $multiplier \times \frac{area(J_i)}{Allocated\_Area(x+1)}$.
\end{enumerate}
\end{document}
