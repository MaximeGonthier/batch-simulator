...
To do this we do: $C = \inputs(\Node{i})~that~end~before~A~ \times \frac{\core(J_i)}{\core(\Node{i})}$
...
\begin{algorithmic}[1]
\ForEach {$J_i \in \jobset$}
	\State Schedule $J_i$ on the node with the earliest completion time. \Comment{Thus taking into consideration the transfer time.}
	%~ \State Remove $J_i$ from $\jobset$
\EndFor
\end{algorithmic}
\end{algorithm}
...
\ForEach {$J_i \in \jobset$}
	\ForEach {$\Node{k} \in \nodeset$}
		...
		\State $C \gets (\inputs(\mathit{sub\_J}) \times \frac{\core(J_i)}{\core(\Node{k})})/\bandwidth$
		\State $score_{\Node{k}} \gets A + B\_multiplier \times B + C\_multiplier \times C$
		\If {$\exists \mathit{Cores\_Hole}(\Node{k}) \subset \core(\Node{k})~such~as~|\core(J_i)| \leq |\mathit{Cores\_Hole}(\Node{k})| \wedge current~time + \walltime(J_i) \leq \mathit{Cores\_Hole}(\Node{k})~next~start~time$} \Comment{Not exactly correct ? A job can use cores from inside and outside of a hole ?}
...
%~ \begin{algorithm}[htbp]
%~ \caption{SCORE LOCALITY-CONSERVATIVE BF}
%~ \hspace*{\algorithmicindent} \textbf{Input: Set of queued jobs $\jobset$. Set of nodes $\nodeset$.} \\
%~ \begin{algorithmic}[1]
%~ \State $B\_multiplier \gets 500$
%~ \State $C\_multiplier \gets 1$
%~ \ForEach {$J_i \in \jobset$}
	%~ \ForEach {$\Node{k} \in \nodeset$}
		...
		%~ \State $C \gets (\memory(\inputs(\Node{k})~that~end~before~A) \times \frac{\core(J_i)}{\core(\Node{k})})/\bandwidth$
		%~ \State $score_{\Node{k}} \gets A + B\_multiplier \times B + C\_multiplier \times C$
		%~ \If {$\exists \mathit{Cores\_Hole}(\Node{k}) \subset \core(\Node{k})~such~as~|\core(J_i)| \leq |\mathit{Cores\_Hole}(\Node{k})| \wedge t + \walltime(J_i) \leq \mathit{Cores\_Hole}(\Node{k})~next~start~time \wedge (\inputs(\mathit{Cores\_Hole}(\Node{k})~next~job) = \inputs(J_i) \vee \inputs(\mathit{Cores\_Hole}(\Node{k})~next~job) \notin \inputs(\Node{k}))$}
			%~ \State $A \gets t$
			%~ \State $B \gets$ the time to load $\inputs(J_i)$ on $\Node{k}$ at time $A$
			%~ \State $C \gets (\memory(\inputs(\Node{k})~that~end~before~A) \times \frac{\core(J_i)}{\core(\Node{k})})/\bandwidth$
			%~ \State $score_{\mathit{Cores\_Hole}(\Node{k})} \gets A + B\_multiplier \times B + C\_multiplier \times C$
...
%~ # Pour afficher total flow et file transfer aussi sur Adaptative Multiplier
%~ \begin{figure}[H]\centering
...
%~ \hspace*{\algorithmicindent} \textbf{Input: Set of queued jobs $\jobset$. Set of nodes $\nodeset$.} \\
%~ \begin{algorithmic}[1]
	%~ \State $Flow\_EFT \gets$ EFT($\jobset$, $\nodeset$) 
	%~ \State $Flow\_locality \gets$ LOCALITY($\jobset$, $\nodeset$)
	%~ \If{$Flow\_EFT < Flow\_locality$}
		%~ \State EFT($\jobset$, $\nodeset$) 
	%~ \Else
...
%~ \begin{algorithmic}[1]
	%~ \ForEach{$J_i \in \jobset$}
		%~ \ForEach {$\Node{k} \in \nodeset$}
			...
			%~ \State $B \gets$ the time to load $\inputs(J_i)$ on $\Node{k}$ \Comment{Or time waiting for the file to be loaded by another job.}
			%~ \State $C \gets (\memory(\inputs(\Node{k})~that~end~before~A) \times \frac{\core(J_i)}{\core(\Node{k})})/\bandwidth$
			%~ \State $score_{\Node{k}} \gets B + C$
		%~ \EndFor
		%~ \State Schedule $J_i$ on the node with the smallest score. Schedule on the node with the lowest $EAT$ in case of a tie. Schedule on the node with the lowest index in case of a second tie.
		%~ \State Remove $J_i$ from $\jobset$
	%~ \EndFor
%~ \end{algorithmic}
%~ \end{algorithm}

\subsection{Adaptative Multiplier}
...
\caption{Data persistence - Workload of July 18}\end{figure}
...
\caption{Data persistence - Workload of July 16	}\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[width=1\linewidth]{MBSS/plot/Results_Percentage_FCFS_2022-07-18->2022-07-18_V9271_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{No bf}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[width=1\linewidth]{MBSS/plot/Results_Percentage_FCFS_BF_2022-07-18->2022-07-18_V9271_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{With bf}\end{subfigure}
\caption{Percentage of reduction compared to FCFS or FCFS BF}\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[width=1\linewidth]{MBSS/plot/Results_Percentage_FCFS_All_workloads_mean_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{No bf}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[width=1\linewidth]{MBSS/plot/Results_Percentage_FCFS_BF_All_workloads_mean_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{With bf}\end{subfigure}
\caption{Percentage of reduction compared to FCFS or FCFS BF on all workloads}\end{figure}

%~ \begin{figure}[H]\centering
%~ \begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[width=1\linewidth]{MBSS/plot/2022-07-18->2022-07-18_V9271_Fcfs_Used_nodes_450_128_32_256_4_1024.pdf}\caption{Cluster's usage}\end{subfigure}
%~ \begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[width=1\linewidth]{MBSS/plot/2022-07-18->2022-07-18_V10000_Fcfs_Used_nodes_reduced_450_128_32_256_4_1024.pdf}\caption{Cluster's usage reduced}\end{subfigure}
%~ \caption{Clusters usage}\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-07-16->2022-07-16_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage FCFS 07-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-07-16->2022-07-16_V10000_Fcfs_with_a_score_mixed_strategy_x500_x1_x0_x0_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage EFT-SCORE 07-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch 07-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use 07-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time 07-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch BF 07-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use BF 07-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-07-16->2022-07-16_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time BF 07-16}\end{subfigure}\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-09-13->2022-09-13_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage FCFS 09-13}\end{subfigure}
%~ \begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-09-13->2022-09-13_V10000_Fcfs_with_a_score_mixed_strategy_x500_x1_x0_x0_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage EFT-SCORE 09-13}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-13->2022-09-13_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch 09-13}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-13->2022-09-13_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use 09-13}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-13->2022-09-13_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time 09-13}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-13->2022-09-13_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch BF 09-13}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-13->2022-09-13_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use BF 09-13}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-13->2022-09-13_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time BF 09-13}\end{subfigure}\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-03-26->2022-03-26_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage FCFS 03-26}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-03-26->2022-03-26_V10000_Fcfs_with_a_score_mixed_strategy_x500_x1_x0_x0_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage EFT-SCORE 03-26}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-03-26->2022-03-26_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch 03-26}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-03-26->2022-03-26_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use 03-26}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-03-26->2022-03-26_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time 03-26}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-03-26->2022-03-26_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch BF 03-26}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-03-26->2022-03-26_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use BF 03-26}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-03-26->2022-03-26_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time BF 03-26}\end{subfigure}\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-09-09->2022-09-09_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage FCFS 09-09}\end{subfigure}
%~ \begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-09-09->2022-09-09_V10000_Fcfs_with_a_score_mixed_strategy_x500_x1_x0_x0_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage EFT-SCORE 09-09}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-09->2022-09-09_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch 09-09}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-09->2022-09-09_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use 09-09}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-09->2022-09-09_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time 09-09}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-09->2022-09-09_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch BF 09-09}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-09->2022-09-09_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use BF 09-09}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-09->2022-09-09_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time BF 09-09}\end{subfigure}\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-09-11->2022-09-11_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage FCFS 09-11}\end{subfigure}
%~ \begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-09-11->2022-09-11_V10000_Fcfs_with_a_score_mixed_strategy_x500_x1_x0_x0_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage EFT-SCORE 09-11}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-11->2022-09-11_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch 09-11}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-11->2022-09-11_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use 09-11}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-09-11->2022-09-11_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time 09-11}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-11->2022-09-11_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch BF 09-11}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-11->2022-09-11_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use BF 09-11}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-09-11->2022-09-11_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time BF 09-11}\end{subfigure}\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-08-16->2022-08-16_V10000_Fcfs_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage FCFS 08-16}\end{subfigure}
%~ \begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Cluster_usage/2022-08-16->2022-08-16_V10000_Fcfs_with_a_score_mixed_strategy_x500_x1_x0_x0_Used_nodes_Reduced_450_128_32_256_4_1024_core_by_core.pdf}\caption{Cluster usage EFT-SCORE 08-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-08-16->2022-08-16_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch 08-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-08-16->2022-08-16_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use 08-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/Results_FCFS_Score_Backfill_2022-08-16->2022-08-16_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time 08-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-08-16->2022-08-16_V10000_Mean_Stretch_450_128_32_256_4_1024.pdf}\caption{Stretch BF 08-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-08-16->2022-08-16_V10000_Number_of_data_reuse_450_128_32_256_4_1024.pdf}\caption{Data re-use BF 08-16}\end{subfigure}
\begin{subfigure}[b]{0.4\linewidth}\centering\includegraphics[scale=0.35]{MBSS/plot/BF_Results_FCFS_Score_Backfill_2022-08-16->2022-08-16_V10000_Total_waiting_for_a_load_time_and_transfer_time_450_128_32_256_4_1024.pdf}\caption{Load time BF 08-16}\end{subfigure}\end{figure}
