...
#~ python3 src/plot_queue_times.py outputs/Stretch_times_FCFS.txt outputs/Stretch_times_SCORE.txt stretch
...
#~ mv plot.pdf plot/Stretch_times_FCFS_SCORE_${WORKLOAD_TP}_${CLUSTER_TP}.pdf
