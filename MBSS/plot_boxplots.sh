...
python3 src/plot_boxplot.py ${date1} ${date2} byuser NO_BF transfer_time 0 hist
...
python3 src/plot_boxplot.py ${date1} ${date2} byuser NO_BF bounded_stretch 0 boxplot

python3 src/plot_boxplot.py ${date1} ${date2} byuser BF transfer_time 0 hist
...
python3 src/plot_boxplot.py ${date1} ${date2} byuser BF bounded_stretch 0 boxplot
