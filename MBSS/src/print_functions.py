def print_decision_in_scheduler(choosen_core, j, choosen_node):
	...
	core_ids.sort()
	print("Job", j.unique_id, "using file", j.data, "category", j.index_node_list, "will be computed on node", choosen_node.unique_id, "core(s)", core_ids, "start at time", j.start_time, "and is predicted to finish at time", j.end_time)
