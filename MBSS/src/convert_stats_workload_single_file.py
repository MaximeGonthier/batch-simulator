...
DATE = sys.argv[1]
f_output1 = open("inputs/workloads/converted/distribution/" + DATE + "_walltime", "w")
f_output2 = open("inputs/workloads/converted/distribution/" + DATE + "_delay", "w")
f_output3 = open("inputs/workloads/converted/distribution/" + DATE + "_cores", "w")
...
# ~ for i in range (1, LAST_DAY + 1):
	...
	# ~ print(FILENAME)
f_input = open("inputs/workloads/raw/" + DATE, "r")
