...
def start_job_immediatly_specific_node_size(job, node_sublist, current_time):
	for n in node_sublist:
		...
		if earliest_available_time == current_time: # Ok I can start immediatly, schedule job and return true
