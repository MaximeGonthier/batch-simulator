...
do
	...
	elif [ $((i)) == 10 ]; then SCHEDULER="Fcfs_with_a_score_backfill_big_nodes_95th_percentile_x500_x500_x0_x0"
	elif [ $((i)) == 11 ]; then SCHEDULER="Fcfs_with_a_score_backfill_big_nodes_weighted_random_x500_x500_x0_x0"
	elif [ $((i)) == 12 ]; then SCHEDULER="Fcfs_with_a_score_backfill_big_nodes_gain_loss_tradeoff_x500_x500_x0_x0"
	elif [ $((i)) == 13 ]; then SCHEDULER="Fcfs_area_filling_with_a_score_x500_x500_x0_x0"
	elif [ $((i)) == 14 ]; then SCHEDULER="Fcfs_area_filling_omniscient_with_a_score_x500_x500_x0_x0"
	elif [ $((i)) == 15 ]; then SCHEDULER="Fcfs_area_filling_with_ratio_with_a_score_x500_x500_x0_x0"
	elif [ $((i)) == 16 ]; then SCHEDULER="Fcfs_area_filling_with_ratio_7_days_earlier_with_a_score_x500_x500_x0_x0"
	elif [ $((i)) == 17 ]; then SCHEDULER="Fcfs_area_filling_omniscient_with_ratio_with_a_score_x500_x500_x0_x0"
	elif [ $((i)) == 18 ]; then SCHEDULER="Fcfs_with_a_score_area_factor_x500_x500_x0_x500"
	elif [ $((i)) == 19 ]; then SCHEDULER="Fcfs_with_a_score_area_factor_with_planned_area_x500_x500_x0_x1000"
	elif [ $((i)) == 20 ]; then SCHEDULER="Fcfs_with_a_score_area_factor_with_omniscient_planned_area_x500_x500_x0_x1000"
	fi
