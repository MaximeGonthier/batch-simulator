...
do
	...
	elif [ $((i)) == 4 ]; then SCHEDULER="Fcfs_area_filling_with_ratio"
	#~ elif [ $((i)) == 7 ]; then SCHEDULER="Fcfs_area_filling_omniscient_with_ratio"
	elif [ $((i)) == 5 ]; then SCHEDULER="Fcfs_with_a_score_x1_x0_x0_x0"
	elif [ $((i)) == 6 ]; then SCHEDULER="Fcfs_with_a_score_x500_x500_x0_x0"
	...
	elif [ $((i)) == 7 ]; then SCHEDULER="Fcfs_area_filling_omniscient_with_a_score_x500_x500_x0_x0"
	elif [ $((i)) == 8 ]; then SCHEDULER="Fcfs_area_filling_with_ratio_with_a_score_x500_x500_x0_x0"
