...
#~ do
	...
	#~ elif [ $((i)) == 1 ]; then SCHEDULER="Fcfs_with_a_score_x0_x0_x0"
	#~ if [ $((i)) == 2 ]; then SCHEDULER="Fcfs_with_a_score_x1_x1_x1"
	#~ if [ $((i)) == 3 ]; then SCHEDULER="Fcfs_with_a_score_x2_x1_x1"
	#~ elif [ $((i)) == 4 ]; then SCHEDULER="Fcfs_with_a_score_x4_x1_x1"
	#~ elif [ $((i)) == 5 ]; then SCHEDULER="Fcfs_with_a_score_x1_x2_x1"
	#~ elif [ $((i)) == 6 ]; then SCHEDULER="Fcfs_with_a_score_x1_x4_x1"
	#~ elif [ $((i)) == 7 ]; then SCHEDULER="Fcfs_with_a_score_x1_x1_x2"
	#~ elif [ $((i)) == 8 ]; then SCHEDULER="Fcfs_with_a_score_x1_x1_x4"
	#~ fi
