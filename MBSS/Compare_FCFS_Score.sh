...
do
	...
	#~ python3 src/plot_heatmap.py outputs/heatmap_stretch.txt $((N)) ${MULTIPLIER_1} ${MULTIPLIER_2} $((PAS))
	...
	#~ python3 src/plot_heatmap.py outputs/heatmap_stretch_with_a_minimum.txt $((N)) ${MULTIPLIER_1} ${MULTIPLIER_2} $((PAS))
	...
	python3 src/plot_heatmap.py outputs/heatmap_total_flow.txt $((N)) ${MULTIPLIER_1} ${MULTIPLIER_2} $((PAS))
