...
do
	...
	truncate -s 0 outputs/total_flow.txt
	...
	do
		...
		do
			...
			cat outputs/Total_flow_${SCHEDULER}.txt >> outputs/total_flow.txt
			echo "" >> outputs/heatmap.txt
			echo "" >> outputs/total_flow.txt
	...
	python3 src/plot_heatmap.py outputs/total_flow.txt $((N)) ${MULTIPLIER_1} ${MULTIPLIER_2}
	mv plot.pdf plot/Total_flow_heatmap_FCFS_Score_${MULTIPLIER_1}_${MULTIPLIER_2}_${WORKLOAD_TP}_${CLUSTER_TP}.pdf
	mv outputs/total_flow.txt data/Total_flow_heatmap_FCFS_Score_${MULTIPLIER_1}_${MULTIPLIER_2}_${WORKLOAD_TP}_${CLUSTER_TP}.txt
done
