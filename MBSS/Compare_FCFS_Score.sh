...
do
	...
	#~ elif [ $((i)) == 5 ]; then SCHEDULER="Fcfs_with_a_score_x3_x1" 
	#~ elif [ $((i)) == 6 ]; then SCHEDULER="Fcfs_with_a_score_x3.5_x1" 
	#~ elif [ $((i)) == 7 ]; then SCHEDULER="Fcfs_with_a_score_x4_x1" 
	#~ elif [ $((i)) == 8 ]; then SCHEDULER="Fcfs_with_a_score_x4.5_x1" 
	#~ elif [ $((i)) == 9 ]; then SCHEDULER="Fcfs_with_a_score_x5_x1" 
	#~ elif [ $((i)) == 10 ]; then SCHEDULER="Fcfs_with_a_score_x1_x1.5"
	#~ elif [ $((i)) == 11 ]; then SCHEDULER="Fcfs_with_a_score_x1_x2"
	#~ elif [ $((i)) == 12 ]; then SCHEDULER="Fcfs_with_a_score_x1_x2.5"
	#~ elif [ $((i)) == 13 ]; then SCHEDULER="Fcfs_with_a_score_x1_x3"
	fi
