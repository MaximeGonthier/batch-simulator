...
%~ \begin{frame}{Dense outer product with 2 Tesla V100 GPUs}
	%~ \begin{figure}
		%~ \center\includegraphics[scale = 0.45]{../Starpu/R/Courbes/PlaFRIM-Grid5k/Matrice_ligne/GF_dynamic_data_aware_no_hfp_gemini-2-ipdps_2GPU.pdf}
	%~ \end{figure}
	%~ \begin{itemize}
...
%~ \begin{frame}{Amount of data transfers on the dense outer product with 2 Tesla V100 GPUs}
	%~ \begin{figure}
		%~ \center\includegraphics[scale = 0.45]{../Starpu/R/Courbes/PlaFRIM-Grid5k/Matrice_ligne/DT_dynamic_data_aware_no_hfp_gemini-2-ipdps_2GPU.pdf}
...
%~ % \begin{frame}{Tasks from the Cholesky decomposition with 4 Tesla V100 GPUs}
%~ \begin{frame}{Tasks from the Cholesky decomposition with 4 GPUs}
	%~ \begin{figure}
		%~ \center\includegraphics[scale = 0.45]{../Starpu/R/Courbes/PlaFRIM-Grid5k/Cholesky/GF_dynamic_data_aware_no_hfp_gemini-1-fgcs_4GPU.pdf}
		%~ % \caption{Performance on tasks coming from the Cholesky decomposition in real with 4 Tesla V100 GPUs.}
	%~ \begin{itemize}
...
%~ {
%~ \usebackgroundtemplate{}
%~ \subsection{Sparse 2D matrix multiplication}
%~ \begin{frame}{Sparse 2D matrix multiplication without memory limitation (32GB by GPU) with 4 Tesla V100 GPUs}
%~ % \begin{frame}{Sparse 2D matrix without memory limitation with 4 GPUs}
	%~ \begin{figure}
		%~ \center\includegraphics[scale = 0.4]{../Starpu/R/Courbes/PlaFRIM-Grid5k/Sparse_mem_infinite/GF_dynamic_data_aware_no_hfp_sparse_matrix_infinie_gemini-1-fgcs_4GPU.pdf}
		%~ % \caption{Performance on the sparse 2D matrix multiplication without memory limitation (32GB by GPU) in real with 4 Tesla V100 GPUs.}
	%~ \begin{itemize}
		%~ \item No memory constraint
