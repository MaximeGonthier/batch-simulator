...
# strategy_max = c(rep(c(rep("h0", times=10), rep("h111", times=10), rep("h112", times=10), rep("h113", times=10), rep("h121", times=10), rep("h122", times=10), rep("h123", times=10)),times=event_repeat_times))
# strategy_mean = c(rep(c(rep("h0", times=11), rep("h111", times=11), rep("h112", times=11), rep("h113", times=11), rep("h121", times=11), rep("h122", times=11), rep("h123", times=11)),times=event_repeat_times))

# strategy_max = c(rep(c(rep("h0", times=10), rep("h211", times=10), rep("h212", times=10), rep("h213", times=10), rep("h221", times=10), rep("h222", times=10), rep("h223", times=10)),times=event_repeat_times))
# strategy_mean = c(rep(c(rep("h0", times=11), rep("h211", times=11), rep("h212", times=11), rep("h213", times=11), rep("h221", times=11), rep("h222", times=11), rep("h223", times=11)),times=event_repeat_times))

strategy_max = c(rep(c(rep("h0", times=10), rep("h311", times=10), rep("h312", times=10), rep("h313", times=10), rep("h321", times=10), rep("h322", times=10), rep("h323", times=10)),times=event_repeat_times))
strategy_mean = c(rep(c(rep("h0", times=11), rep("h311", times=11), rep("h312", times=11), rep("h313", times=11), rep("h321", times=11), rep("h322", times=11), rep("h323", times=11)),times=event_repeat_times))
...
for(nn in 0:(event_repeat_times-1)){
  ...
  # files<-c(filename0,filename111,filename112,filename113,filename121,filename122,filename123)
  ...
  # files<-c(filename0,filename211,filename212,filename213,filename221,filename222,filename223)
  ...
  files<-c(filename0,filename311,filename312,filename313,filename321,filename322,filename323)
  ...
  for (ii in 1:7){
    ...
    data = data[!grepl("checkpoint", data[,1]),] #remove checkpoint job
    ...
    data_jobfristsucceed <- data_jobfristsucceed%>%dplyr::mutate(flow =  as.numeric(data_jobfristsucceed[,11]) - as.numeric(data_jobfristsucceed[,4])) 
  ...
  max_all = c(max_all,max_heuristic_all)
  mean_all = c(mean_all,mean_heuristic_all)
}
