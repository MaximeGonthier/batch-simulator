...
\begin{figure}[tb]
		...
		\begin{tikzpicture}[thick]
			...
			\onslide<2-> { \draw[color=black, fill=blue!40] (-2.9*\x, 1.8*\y) rectangle (1.9*\x, 1.7*\y)  node[midway] {}; }
			%~ \onslide<3-> { \draw[color=black, fill=blue!40] (-2.8*\x, -0.6*\y) rectangle (1.8*\x, -0.7*\y)  node[midway] {}; }
			%~ \onslide<4-6> { \draw[color=black, fill=blue!40] (-2.8*\x, -0.4*\y) rectangle (1.8*\x, -0.5*\y)  node[midway] {}; }
			%~ \onslide<5-5> { \draw[color=black, fill=blue!40] (-2.8*\x, -0.2*\y) rectangle (1.8*\x, -0.3*\y)  node[midway] {}; } 
			%~ \onslide<6-12> { \draw[color=black, fill=blue!40] (-2.8*\x, -0.8*\y) rectangle (-0.8*\x, -0.9*\y)  node[midway] {}; }
			%~ \onslide<7-7> { \draw[color=black, fill=blue!40] (-2.8*\x, -0.6*\y) rectangle (-0.8*\x, -0.7*\y)  node[midway] {}; }
			%~ \onslide<8-10> { \draw[color=black, fill=blue!40] (-1.5*\x, 2.2*\y) rectangle (0.5*\x, 2.1*\y)  node[midway] {}; }
			%~ \onslide<13-> { \draw[color=black, fill=blue!40] (-1.5*\x, 2.2*\y) rectangle (0.5*\x, 2.1*\y)  node[midway] {}; }
