...
50\% of \uss.
\mx{tableau d'ameliorations par rapport à FCFS}
...
\begin{tabular}{ l c c c c }
  ...
  Schedulers & EFT & \textbf{LEA} & LEO & LEM \\
  \midrule
  Mean improvement from FCFS & 0.4\% & \textbf{20.8}\% & 1.0\% & 11.4\% \\
  \midrule
  Median improvement from FCFS & 0.4\% & \textbf{20.8}\% & 1.0\% & 11.4\% \\
  \bottomrule
\end{tabular}
\caption{\mx{A REMPLIR} Stretch's improvement from FCFS on week 43.}\label{tab.43.stretch}
\end{table}
\begin{table}
\centering
\begin{tabular}{ l c c c c }
