...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		% Pour jeudi 11h
		\item New acronyms and color code
		\item Tracer un trait a 1 pour les barplot et l'expliquer (temps attendu, exactement ton temps de chargements)
		\item ractoter calcul whisker boxplot, le 1/8eme, l'octile. Donc 3/4 dans les moustaches (mais aussi du bas de la boite a max)
	\end{enumerate}
