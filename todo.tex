...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		% Uppsala
		\item HEFt est bien pareil que FCFS\_score\_x1 dans les résultats.
		\item j'ai lancé try heft else do score sur u workload plus long mais ca a pas fini en 14h
	\end{enumerate}
