...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		\item New workload generation: written but not coded
...
\section{Todo}
	\subsection{General}
		\begin{enumerate}	
			...
			\iem Voir rapport avec A
			\item voir uantité de petits jobs
			\item représenter taille du job sur meme courbe
			faire ratio au lieu de difference dans comparaison avec fcfs	
				
			\item Soumettre abstract et poster ce soir
			\item Envoyer param hMETIS a Bora
			\item coder new workload fix state
