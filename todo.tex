...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			\item Faire grand test Score avec heatmap stretch et distribution des queeu et flow et stretch tt ce que ya dans FCFS\_Compare en gros
			\item tirer conclusion fcfs score
			\item Pareil contraintes tailles
		
			
			\item same with stretch on Y and all the schedulers on X
