...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
		%~ mgonthier@flyon:~/data-aware-batch-scheduling/MBSS$ oarsub -p nova -l core=16,walltime=55:00:00 -r '2022-11-05 00:10:00' "bash Compare_FCFS_Score.sh inputs/workloads/converted/2022-08-16-\>2022-08-16_V9271 inputs/clusters/rackham_450_128_32_256_4_1024.txt 0 6"
		%~ OAR_JOB_ID=1400573
		
		%~ + 1 job avec mai 21 pour fcfs score classique (OAR.1400569.stdout)

			\item Comprendre les resultats de score 08 16
