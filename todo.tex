...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			...
			\item re test with new method of 3 phases
			...
			\item Faire multi phase en divisant par 3 en triant par temps de soumissions
			\item Plot nb de noeuds utilisé en plus de nb de coeurs
			\item Stats Nb de job scheduled qui demande 5 10 ou 20 coeurs
			\item Stats sur les jobs dans la file d'attente comme charge mais avec nb de scheduled jobs
			\item Modifier pseudocode maximum use single file sur la recherche du noeud qui a déjà la donnée
