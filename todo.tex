...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
			...
			\item smooth transtion: probability of needing all nodes ? Try math functions ?
			\item Garder une donnée si elle rentre en memoire malgré un autre job qui tourne ou commence. Sinon l'enlever. ca appote un problème d'eviction. Du coup j'evince la donnée qui a l'indice le plus faible.
