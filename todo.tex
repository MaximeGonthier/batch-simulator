...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		\item stretch with a minimum I do: bounded_stretch = $t/max(t\_empty\_cluster, 5min)$.
	\end{enumerate}
...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			...
			\item poser congés
			\item dans l'algo area filling ajouter une confditin pour dire pas besoin de test pour x taille x et enlever le infinie. Enlever le paragraphe au dessu de infinie.
