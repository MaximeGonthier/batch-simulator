...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
			...
			\item coder conservative bf pour heft fcs et un algo localité et le comparer a nos methodes sans rien pour voir. Je peux regarder uniquement les trou avec le temps de début == t. A vérifier.
