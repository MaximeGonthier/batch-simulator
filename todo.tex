...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		\item Some heatmaps (max flow, total flow, max stretch, mean stretch, max bounded stretch, mean bounded stretch)
		\item Reduced complexity on nb of copy
		\item stretch with a minimum pour tous les jobs on fais: bounded_stretch = t/max(t_tt_seul, 5min)
	\end{enumerate}
