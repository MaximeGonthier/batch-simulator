...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		\item pseudocode est pas indénombrable ?
		\item relecture et ajout d'un todo sur settings + sur les deux mentions du scheduling time à vérifier.
...
\section{Questions for next meeting}
	\begin{enumerate}
		...
		\item Etudier la charge du cluister core ar core au sein de chaque node ? Puis essayer de prédire comment ca va se remplir avec les jobs suivants ?
