...
\section{Questions for next meeting}
	\begin{enumerate}
		\item Mettre des inputs pour reproduire les expé ? Dire dans le texte que ils peuvent reproduire les expés également ? Do we need a credit or copyright ?
		...
		\item removed figure of nb of data reused
		\item I can still remove the fig and just explain section 5.E and the part were I talk about the methodology to get all jobs
		\item code depot: Do i add inputs of workloads? Or it's not ok for double blind? Besoin de Se couvrir juridiquement ?
	\end{enumerate}
...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
			\item readme
			\item voir badge reproductibilité
			\item ajouter copyright anonyme. Passer repo principal en privé du coup ?
