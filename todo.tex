...
\section{Questions for next meeting}
	\begin{enumerate}
		...
		\item Pour les courbes par 4 on peut aussi le faire avec 3D/3D simu/3D DT/Cholesky. Changer le texte une fois la configuration validé pour ne pas parlé des méthodes non montrées
		\item Besoin d'aide pour reviewer 2 dernière question.
	\end{enumerate}
