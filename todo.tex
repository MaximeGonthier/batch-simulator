...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		\item Enlever les DOI des related work et autre. Attention pour parla il faut garder l'url ?
...
\section{Todo}
	...
	\subsection{FGCS}
		\begin{enumerate}
			...
			\item fusionner fig 5 et 6. Mettre fond blanc à tous. Garder les points. Enlever fig13 (simu 3D). Les 6 dernières, les mettres ne 2 colonnes 3 lignes. Alleger les schedulers. Enlever le HFP with sched time fast start de 3D. Simplifier les lignes horizontales et verticales et bien les expliquer avant dans le texte au moment de 2D. Garder only belady et only flip. Enlever mst.
