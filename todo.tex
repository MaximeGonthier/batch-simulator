...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			...
			\item se renseigner payement enseirb semestre 1: attendre fin octobre début novembre
...
%~ mgonthier@flyon:~/data-aware-batch-scheduling/MBSS$ oarsub -p nova -l core=16,walltime=62:00:00 -r '2022-11-04 19:00:00' "./C/main inputs/workloads/converted/2022-05-21-\>2022-05-22_V9271 inputs/clusters/rackham_450_128_32_256_4_1024.txt Fcfs_with_a_score_x500_x1_x0_x0 0 outputs/test.csv 0"
%~ OAR_JOB_ID=1400025
%~ mgonthier@flyon:~/data-aware-batch-scheduling/MBSS$ oarsub -p nova -l core=16,walltime=62:00:00 -r '2022-11-04 19:00:00' "./C/main inputs/workloads/converted/2022-08-16-\>2022-08-16_V9271 inputs/clusters/rackham_450_128_32_256_4_1024.txt Fcfs_with_a_score_x500_x1_x0_x0 0 outputs/test.csv 0"
%~ OAR_JOB_ID=1400039

			\item fcfs score bus error sur mars 15 16 avec conservative bf mais pas sans: j'ai retesté avce moins de loop

			\item score crash avec les longst test masi avant c'était pas le cas
			\item tester mars 15 16
			\item verif le nouveau get current intervals: même resultats avec mixed strategy
			\item 32 et 33 lancé pour voir avec ulimit si ca crash pas: ok mais pas afficher dans le fichier ni sur le printf
			\item le get interval et le free asocié marche mal: le free me fais encore des erros nb of cores in node a la toute fin
			\item commencer à faire un résumé.
			\item test mai easy bf en cours: n'ont pas pu terminer voir les traces
			\item verif 1 sur Jan 21 easy bf (anormalment proche de 1) Peut etre a cause de l'utilisation du cluster et du peu de nombre de jobs à schedule ?
			\item verif perf conservative bf avec eft-score mix (anormalement haut)
			...
			\item score crash avec conservative backfill
