...
\section{Questions for next meeting}
	\begin{enumerate}
		\item talk more about results with BF in section 6 on the first few subsections ?
		\item Are whiskers ok ? And Y axis on boxplots ?
...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
			...
			\item related work bf et le mentionner en disant as said in related work we do ....
