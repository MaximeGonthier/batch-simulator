...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
			...
			\item Garder une donnée si elle rentre en memoire malgré un autre job qui tourne ou commence. Sinon l'enlever. ca appote un problème d'eviction. Du coup j'evince la donnée qui a l'indice le plus faible. La pb que je fias une data dans score or mtn j'ai plus le nb task using it
