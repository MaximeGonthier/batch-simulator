...
\section{Questions for next meeting}
	\begin{enumerate}
		\item Faire de multiplier evicted file un tie breaker seulement ? Pareil avec nb of copy en second tiebreaker ? Comme ça on enlève un peu ce côté mélange du score
		\item Faire if EAT is t avec une fenêtre à la place de t ?
		\item Strat ou plus le EAT le plus tôt sur toutes les nodes est loin, plus on fais un multiplicateur du score élevé ?
	\end{enumerate}
