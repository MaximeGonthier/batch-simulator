...
\section{Questions for next meeting}
	\begin{enumerate}
		\item https://www.researchoutreach.org me contacte pour mettre en avant notre article ?
		\item je me fais inviter pour être revoiewer partout
...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
			\item varier les ratio de chaque taille voir si a un moment l'agressivité est detrimentale
			\item 1 mois entier et couper pour voir si on a vraiment tout
