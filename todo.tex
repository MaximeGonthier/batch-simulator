...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		\item correction du bakcfill conservateur: utiliser en prio les trou qui match le plus notre taille (risque de delay des jobs plus loin si le job qui force le trou se termne avant le alltime) avant de regarder les autres noeuds, possibilité d'utiliser des cores dans un trou et pas dans un trou + creation au minimu de trous.
	\end{enumerate}
