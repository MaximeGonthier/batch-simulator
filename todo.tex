...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
%~ 1403405                   mgonthier      2022-11-09 19:22:43 R default   
%~ 1403406                   mgonthier      2022-11-09 19:25:58 R default   
%~ 1403407                   mgonthier      2022-11-09 19:26:25 R default   
%~ 1403408                   mgonthier      2022-11-09 19:26:53 R default   
%~ 1403409                   mgonthier      2022-11-09 19:27:17 R default   
%~ 1403410                   mgonthier      2022-11-09 19:27:53 R default   

		\item maj algo et ecrire pseudocode EASY et CONSERVATIVE BF, comment ca se code d'habitude et comment moi je l'ai codé, mail à Loris
		\item retester conservative bf pour nos algos et fcfs sans cette contrainte de tour de boucles et avec note condition sur le backfill que si ré utilisations
		\item plotter le nb de cores demandé en attente a la place de nb de jobs en attente
		\item sur cluster usage plot nb jobs evalué au temps t soumis avec une autre courbe
		\item demander pour les petits jobs le temps de chargement fes fichiers cohérent ? 6.4 pour 125 de delai ca ne l'est pas.
		\item compter le nb de reutilisation des données (hors persistence)
		\item regarder pic job queu mars 15 16 workload
		\item faire petit résumé pour jeudi soir	
