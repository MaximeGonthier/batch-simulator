...
\section{Questions for next meeting}
	...
	\begin{enumerate}
		...
		\item Diapos: Simplifier Problem modeling ? Car après j'ai A bi-objective optimization problem. A garder. Slide 6, le point 1 est le titre de l'énuération ou alors l'enlever et le mettre en titre de block. a la place de some data mettre evict en rouge. ENsuite load en rouge, et process en rouge ensuite.
		\item Slides 11 12 13, garder les points importants. Enlever le 11 et l'expliquer sur un dessin avant. Oublier la randomisation. 12 avec intuition une phrase courte ca peut marcher. Et simplifier le détail.
		\item logo anr et inria et cnrs sur la slide 1 en bas a droite
		\item conclusion, parler eviction, recouvrement, temps de schedule, et pk darts est bon dans ce problème ?
	\end{enumerate}
