...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		\item pseudo code area filling with different filling of allocated area
	\end{enumerate}
...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			\item code update intelligent de allocated area
			\item ignore dt for constraint = 1!
			\item area filing: veriff avec loris ce qu e j'ai ecrit puis le coder
