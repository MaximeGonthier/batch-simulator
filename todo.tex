...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		...
		\item code backfill strat 2
		\item code backfill strat 1 corrigé mais pas vérifié
		\item code area filling strat 1
		\item code area filling strat 2
	\end{enumerate}
...
\section{Todo}
	...
	\subsection{Uppsala}
		\begin{enumerate}
			\item test size constraint area filling normal et ratio en regardant 14 jours dans le passé. plutot montrer workload par workload
			\item Coder 95th percentile complexité réduite: a verifier
			\item coder les 5 strats mix
			\item les tester avec size constrain = 1
