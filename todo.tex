...
\section{Questions for next meeting}
	\begin{enumerate}
		\item new cluster usage, pas sur de l'axe Y, un axe Y a 80000 fais tout ecraseR. je peux mettre a 17000 et mettre en log que pour le 80000?
		\item preciser BF dans le nom des algos sur les plots ou le hachage suffit ? En parler dans les sections tout le temps ?
		\item speed-up or speed up or speedup?
		\item fig 19 to compare BF-non bf
