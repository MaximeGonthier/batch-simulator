...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			...
			\item un score sur la categorie de node utilisé (pénalité si plus haut ?) + mode 1 avec queue time moyen actuel. Fusionner fcfs score et area et/ou backfill big nodes mode 1 et mettre la contrainte des tailles et les temps de chargements.
