...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			\item plot dans un fichier a part les heatmap
			\item avant de lancer omnisicent dans le script, lancer la génération avec le mode omnisicent pour les fichiers
