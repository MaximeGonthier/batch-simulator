...
\section{What's new since last meeting ?}
	...
	\begin{enumerate}
		\item X de courbes VS avec submission time et non job id + transparence des points. Lines at 200\% cause when one of them is 0, the percentage of difference is always 200\%
		\item trace size constraint why such a big difference in gantt charts
	\end{enumerate}
...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			\item Courbe vs mettre points transfparents
			\item Heatmap flow ET stretch et stretch avec minimum on delay
			
			\item Attendre mail poster
