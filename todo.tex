...
\section{Todo}
	\subsection{General}
		\begin{enumerate}
			\item tester que les 2 algos que j'ai fais marche comme je veux.
			\item trier par taille de fichier ?
			\item tester en faisant varier le multiplicateur
			\item mettre a jour planned area ?
			\item tester un fcfs with a score no use bigger nodes ?
